...
--
-- Hôte : localhost:3306
-- Généré le :  mer. 23 jan. 2019 à 09:31
...
(181, 1, 'KUv6', 'Tondeuse à gazon', 't', '50.00', 43, 'Verty', 'jpg', '2019-01-23', NULL, 0);
...
--
ALTER TABLE `produits`
  MODIFY `pro_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Clé de la table produits', AUTO_INCREMENT=183;
